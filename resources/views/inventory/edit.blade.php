...
<div class="row">
    <div class="col">
        <form method="POST" action="/inventory/{{$parts->id}}">
            @csrf
            <div class="form-row">
                <div class="form-group col-md-12">
                    <label for="inputCity">Nombre de parte</label>
                    <input type="text" class="form-control" id="inputCity" placeholder="IMAC 27, LAPTOP TOSHIBA, LAPTOP DELL, MOUSE INALAMBRICO, ETC." name="name_part" required value="{{$parts->name_part}}">
                </div>
            </div>
            <div class="form-row">
